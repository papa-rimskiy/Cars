  ...
  return (
      ...
      <div className="filters_and_information">
        <div className="filters">
          <PriceFilter acceptancePriceOf = {acceptancePriceOf} acceptancePriceTo = {acceptancePriceTo}/>
          <SelectFilter />
        </div>
        <div className="information">
          <h5>Favorite Motors of the World - sale and delivery of cars from America, 
            Europe and Asia. The largest automotive Internet site in the world. New cars at below market prices.
